...
const active_gateways = JSON.parse(world.getDynamicProperty('open_gateways') ?? '[]')
...
world.beforeEvents.worldInitialize.subscribe(({blockComponentRegistry}) => {
    blockComponentRegistry.registerCustomComponent('skybedrock:end_eater', {
        onTick({block}) {
            ...
            the_end.fillBlocks(new BlockVolume(first_corner, other_corner), 'air', {
                blockFilter: {includeTypes: ['end_stone', 'chorus_plant', 'chorus_flower', 'skybedrock:end_eater']}
            })
